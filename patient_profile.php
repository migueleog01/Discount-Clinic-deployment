...
<body>
	...
	<form method="post" action="">
		...
		<div id="phone_number_input" style="display: none;">
			<label for="phone_number">Enter new phone number:</label>
			<input type="text" id="phone_number" name="phone_number" placeholder="123-425-3252" pattern="\d{3}-\d{3}-\d{4}">
		</div>

		<script>
			document.getElementById("field").addEventListener("change", function() {
				var phone_number_input = document.getElementById("phone_number_input");
				if (this.value === "phone_number") {
					phone_number_input.style.display = "block";
					document.getElementById("new_value").setAttribute("disabled", true);
				} else {
					phone_number_input.style.display = "none";
					document.getElementById("new_value").removeAttribute("disabled");
				}
			});
		</script>
