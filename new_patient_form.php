  ...
  <form method="post" action="">
    ...
    <form>
      ...
      <script>
        ...
        emergencyContactPhoneInput.addEventListener('input', () => {
          if (!isValidPhone(emergencyContactPhoneInput.value)) {
            emergencyContactPhoneError.textContent = 'Please enter a valid phone number in the format 123-456-7890';
          } else {
